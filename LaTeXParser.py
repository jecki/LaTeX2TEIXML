...
class LaTeXGrammar(Grammar):
    ...
    source_hash__ = "5913d88d3ea018eeaa842b68417220a0"
    ...
    _inline_math_text.set(ZeroOrMore(Alternative(_inline_math_core, Series(_BACKSLASH, Option(Alternative(_LBRACE, _RBRACE))), Series(_LBRACE, _inline_math_text, _RBRACE))))
