...
if __name__ == '__main__':
    ...
    if args.scripts:
        dsl.create_scripts(os.path.join(scriptdir, 'LaTeX.ebnf'))
    ...
    if arg.endswith('.ebnf'):
        ...
        recompile_grammar(os.path.join(scriptdir, 'LaTeX.ebnf'),
                          force=False)
        sys.path.append('.')
        from LaTeXParser import parsing, ASTTransformation, junctions, targets
